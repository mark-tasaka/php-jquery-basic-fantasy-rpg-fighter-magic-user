...
<html>
<head>
<title>Launch Page: Basic Fantasy RPG Fighter/Magic-User Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="fighter_muForm"  target="_blank" method="post">
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#fighter_muForm").attr('action', "character/basic_fighter_mu" + $("#abilityScores").val() +  ".php");
